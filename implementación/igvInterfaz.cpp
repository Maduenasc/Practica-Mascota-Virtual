...
{  int menu_id = glutCreateMenu ( menuHandle );
   glutAddMenuEntry ( _instancia->escena.Accion_n1
                      , _instancia->escena.EscenaA );
   glutAddMenuEntry ( _instancia->escena.Accion_n2
                      , _instancia->escena.EscenaB );
   glutAddMenuEntry ( _instancia->escena.Accion_n3
...
{
    _instancia->escena.giroide.animacionCompleta();
...
{  _instancia->menuSelection = value;
    switch (value){
        case 1: // incrementa comida
            _instancia->escena.actualizaGiroide(1);
            break;
        case 2: // incrementa energia
            _instancia->escena.actualizaGiroide(2);
            break;
        case 3: // incrementa limpieza
            _instancia->escena.actualizaGiroide(3);
            break;
    }
