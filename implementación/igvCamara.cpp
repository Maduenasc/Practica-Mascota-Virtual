...
void igvCamara::siguienteVista() {
    static const igvPunto3D posicion[4] = { igvPunto3D(3,2,4), igvPunto3D(0,5,0), igvPunto3D(5,0,0), igvPunto3D(0,0,5) };
    static const igvPunto3D arriba[4] = { igvPunto3D(0,1,0), igvPunto3D(1,0,0), igvPunto3D(0,1,0), igvPunto3D(0,1,0) };
    static const igvPunto3D vision(0, 0, 0);

    vista = (vista+1) % 4;
    set(posicion[vista], vision, arriba[vista]);
}

void igvCamara::cambiarVista(int _vista) {
    vista = _vista;
    siguienteVista();
}